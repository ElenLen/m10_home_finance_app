...
export class IncomeExpenses {
    ...
    cacheElements() {
        this.elements = {
            ...
            cancelDeleteBtn: document.querySelector('#staticBackdrop .btn-danger[data-bs-dismiss="modal"]'),
    ...
    initDeleteHandler() {
        ...
        document.addEventListener('click', (e) => {
            if (e.target.closest('.delete-operation')) {
                e.preventDefault();
                this.operationToDelete = e.target.closest('.delete-operation').dataset.id;
    ...
    async confirmDelete() {
        ...
        try {
            ...
            const response = await OperationsService.deleteOperation(this.operationToDelete);
    ...
    createOperationRow(operation, number) {
